...
export default function Header() {
  ...
  return (
    <>
      <header className={`w-full overflow-x-hidden fixed top-0 left-0 right-0 z-50 transition-colors duration-300 ${isScrolled ? 'bg-transparent' : 'bg-black/60 backdrop-blur-sm'}`}>
